...
class InstructRAGGenerator:
    """Evidence-grounded resource generation with explicit hidden planning.

    The pipeline stores a concise private rationale for audit and rollback, but
    only ships student-facing Markdown/code/diagram text to the frontend.
    """
