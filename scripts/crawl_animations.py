...
KNOWLEDGE_POINTS: tuple[KnowledgePoint, ...] = (
    ...
    KnowledgePoint("前向传播", "Forward Propagation", "优化",
        ("前向传播 动画", "forward propagation animation", "神经网络 前向传播 计算")),
    ...
    KnowledgePoint("损失函数", "Loss Function", "优化",
        ("损失函数 动画", "loss function visualization", "损失函数 梯度下降 动画")),
    ...
    KnowledgePoint("欠拟合", "Underfitting", "模型评估",
        ("欠拟合 动画", "underfitting animation", "欠拟合 过拟合 对比 可视化")),
    ...
    KnowledgePoint("激活函数", "Activation Function", "神经网络",
        ("激活函数 动画", "activation function visualization", "ReLU Sigmoid Tanh 动画")),
